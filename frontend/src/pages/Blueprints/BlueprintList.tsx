...
export const BlueprintList: React.FC = () => {
    ...
    const fetchBlueprints = async () => {
        try {
            const res = await api.pipelines.listBlueprints();
    ...
    const filtered = blueprints.filter(b =>
        b.blueprint_nm.toLowerCase().includes(search.toLowerCase()) ||
                ...
                <div style={{
                    ...
                    {filtered.map(b => (
                        <div key={b.id} className="glass" style={{
                            ...
                            <div>
                                <h3 style={{ fontSize: '1.1rem', marginBottom: '0.5rem' }}>{b.blueprint_nm}</h3>
